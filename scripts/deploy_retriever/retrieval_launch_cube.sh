...
# export CUDA_VISIBLE_DEVICES=0,1
# file_path=/shared/eng/pj20/cube_data/lveval_index
# index_file=$file_path/e5_Flat.index
# corpus_file=/shared/eng/pj20/cube_data/lveval_corpus_with_index.json
# retriever_name=e5
# retriever_path=intfloat/e5-base-v2
...
export CUDA_VISIBLE_DEVICES=0,1
file_path=/shared/eng/pj20/cube_data/musique_index
index_file=$file_path/e5_Flat.index
corpus_file=/shared/eng/pj20/cube_data/musique_corpus_with_index.json
retriever_name=e5
retriever_path=intfloat/e5-base-v2
