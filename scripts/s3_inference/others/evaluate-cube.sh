...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=verl_checkpoints/s3_8_3_3_3948/actor/global_step_250 \
    ...
    critic.model.path=verl_checkpoints/s3_8_3_3_3948/actor/global_step_250 \
    ...
    +output_context_dir=data/cube/output_sequences_s3_8_3_3_3948_cube_${DATASET} \
    retriever.url="http://127.0.0.1:3000/retrieve" \
    retriever.topk=8 \
    2>&1 | tee evaluation_s3_8_3_3_3948_cube_${DATASET}.log
